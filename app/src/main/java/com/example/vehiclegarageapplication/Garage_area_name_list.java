...
public class Garage_area_name_list extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.garage_area_name_list);
        sharedPrefHandler=new SharedPrefHandler(this);

        strmno=sharedPrefHandler.getSharedPreferences("city");

        listView_temp = (ListView) findViewById(R.id.lv_temp);
        ...
        listView_temp.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                sharedPrefHandler.setSharedPreferences("garea",s);
                Intent intent=new Intent(getApplication(),Garage_name_list.class);
    ...
    private void getProductByCode(final String strmno) {
        ...
        Call<List<Garage>> call = api.getareaname(strmno);
    ...
    private void loadProductListView()
    {
        ...
        {
            products[i] = productList.get(i).getarea_name();
        }
